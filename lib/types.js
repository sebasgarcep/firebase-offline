...
export type UpdatePasswordCallback = (password: string, callback?: ?NodeCallback<void>) => any;
export type UpdatePasswordPromise = (password: string) => Promise<void>;

export type SendPasswordResetEmailCallback = (email: string, callback?: ?NodeCallback<void>) => any;
export type SendPasswordResetEmailPromise = (email: string) => Promise<void>;
